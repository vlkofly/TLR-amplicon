...
seqfile=open('TLR15_forphase.fasta','r')
popfile=open('finalpopTLR15.tsv','r')
#num_lines = sum(1 for line in infile)
#print num_lines
LN=0
nameline=range (1,644,3) #num_lines - 1 # read it in text file
firstline=range (2,645,3) #num_lines
secondline=range (3,646,3) #num_lines + 1
